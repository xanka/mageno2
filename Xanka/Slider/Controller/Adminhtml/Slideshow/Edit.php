...
class Edit extends \Xanka\Slider\Controller\Adminhtml\Slideshow
{
    /**
    ...
    public function execute()
    {
		...
		*/
		...
		/** set doi tuong ra block*/
		 $this->_coreRegistry->register('slideshow_edit', $model);
		 
        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->resultPageFactory->create();
		
        /**$resultPage->setActiveMenu('Xanka_Slider::xanka_slider'); */
        $resultPage->getConfig()->getTitle()->prepend(__('Edit Slideshow'));
        return $resultPage;		
    }
}